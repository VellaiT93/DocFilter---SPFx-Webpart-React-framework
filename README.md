...
Document library Webpart:
  ...
  - Choosable filter (must be a choice field in the document library --- still under construction!)
...
- in the command-line run:
  - **npm install**
  - **gulp serve**
  - Do not forget to update the siteUrl variable with your SharePoint site or use: "this.context.pageContext.web.absoluteUrl"
